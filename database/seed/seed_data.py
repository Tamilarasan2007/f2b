...
Run: python -m database.seed.seed_data
Or import and call init_db() / seed_data() from your app.
"""
...
async def seed_data():
    ...
    async with AsyncSessionLocal() as db:
        ...
        # ── Pickup Requests (realistic demo data) ──
        ...
        print("  Admin:    admin@f2b.in")
        print("  Farmer:   ravi@f2b.in, kumar@f2b.in, selvi@f2b.in, meena@f2b.in, murugan@f2b.in")
        print("  Driver:   driver1@f2b.in, driver2@f2b.in")
        print("  Buyer:    buyer1@f2b.in, buyer2@f2b.in")
        print("  Operator: operator@f2b.in")
